...
class CellPhone(Computer):
    ...
    def __init__(self, network = "Zong", brand = "Apple", noOfIOPorts = 0, manufacturer = ""):
        self.network = network
        self.brand = brand
        super().__init__(noOfIOPorts, manufacturer)
    ...
    def printConfig(self):
        ...
        print(f"Cell Phone Details: \n"
              f"The Network of the Cell Phone is: {self.network}\n"
              f"The brand of the Cell Phone is: {self.brand}")
...
p = CellPhone("Ufone", "Samsung" ,30, "MACBOOK")
p.printConfig()
